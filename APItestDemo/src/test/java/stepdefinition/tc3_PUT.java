...
public void the_user_is_in_the_PUT_URL_https_jsonplaceholder_typicode_com_posts() {
...
@Then("he gets a PUT status code of {int}")
public void he_gets_a_PUT_status_code_of(Integer int1) {
